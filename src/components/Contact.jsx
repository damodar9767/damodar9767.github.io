 ...
 const handleSubmit = (e) =>{
   ...
   emailjs.send(
    ...
    'template_fsa1jrc',
    {
      ...
      to_email: 'tadasdamodar1006@gmail.com',
      message :form.message
    },
    'BRcoXLRgqfnOW0RUs').then(() => {
      setLoading(false);
      ...
      className='flex-[0.75] 
       ...
       className=' mt-12 flex flex-col gap-8'>
        ...
        <input
         ...
         text-white rounded-lg outlined-none border-none fond-medium'
        ...
        className='bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold
         shaodw-md shadow-primary rounded-xl'>
